...
describe('DropdownComponent', () => {
  ...
  it('should changed properties of item when is Active', () => {
    ...
    expect(expectChangeValue.btnName).toEqual('Inactive');
    expect(fakeInfoActive.btnIcon).toEqual(expectChangeValue.btnIcon);
    expect(expectChangeValue.iconColor).toEqual('text-danger');
  });
  ...
  it('should change properties of item when is Inactive', () => {
    ...
    expect(expectChangeValue.btnName).toEqual('Active');
    expect(fakeInfoInactive.btnIcon).toEqual(expectChangeValue.btnIcon);
    expect(expectChangeValue.iconColor).toEqual('text-success');
